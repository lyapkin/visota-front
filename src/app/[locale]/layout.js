							...
							<div className={styles['map-card']}>
								<div className={styles['map-office']}>
									...
									<div>
										...
										<div className={styles['map-office__val']}>{t('common:address')/*г. Уфа, Зарге 19/1*/}</div>
									</div>
									<div>
										<div className={styles['map-office__icon']}>
									...
									<div>
										...
										<div className={styles['map-office__key']}>{t('schedule')}:</div>
										<div className={styles['map-office__val']}
											 dangerouslySetInnerHTML={{__html: t('common:schedule', {interpolation: {escapeValue: false}})}}
										>

...
const ThanksSlider = () => {
  ...
  const percent =
    width <= 768 ? 100 : width <= 992 ? 104.1 : width <= 1450 ? 106.3 : 108.5;
  ...
  return (
    <>
      <div
        className={`${styles["thanks-letters-slider"]} home-catalog-slider-slick`}
      >
              ...
              >
                <div key={item.id} className={styles["thanks-letters-slide"]}>
                  <img
                    ...
                    className={styles["thanks-letters-slide__img"]}
                    src={item.img}
                  />
                </div>
              </div>
      ...
      {showLetter && (
        <Popup close={handleClose}>
          <div className={styles["popup-letter"]}>
            <img
              className={styles["thanks-letters__img-popup"]}
              src={showLetter}
            />

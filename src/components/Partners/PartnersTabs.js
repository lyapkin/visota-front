        ...
        <>
            ...
            {active === 0 && (
                <div className={`${s.content} ${s.enterprises}`}>
                    ...
                    <p className={s.content__text}
                       dangerouslySetInnerHTML={{ __html: t('partners:tab_1_text', { interpolation: { escapeValue: false } }) }}>
                    </p>
            ...
            {active === 1 && (
                <div className={s.content}>
                    ...
                    <p className={s.content__text}
                       dangerouslySetInnerHTML={{ __html: t('partners:tab_2_text', { interpolation: { escapeValue: false } }) }}>
                    </p>
                </div>
            )}
        </>

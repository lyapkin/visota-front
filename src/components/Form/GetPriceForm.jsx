...
import getPriceReducer, {
  getPriceActions,
  getPriceInitState,
} from "@/reducers/getPriceReducer";
  ...
  return (
    <>
      <div className={styles["get-price-form-wrapper"]}>
        ...
        <form
          className={`${styles["get-price-form"]} ${styles["relative"]}`}
        ...
        >
          <TextInput
            ...
            onChange={(e) =>
              dispatch({ type: getPriceActions.NAME, payload: e.target.value })
            }
          ...
          <TextInput
            ...
            onChange={(e) =>
              dispatch({ type: getPriceActions.EMAIL, payload: e.target.value })
            }

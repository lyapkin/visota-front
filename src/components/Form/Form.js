...
const Form = ({ main, popup, buttonText, closePopup, type }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    const urlPath =
      type === "offer" ? "/api/request/offer/" : "/api/request/consultation/";
  ...
  return (
    <div
      className={`${styles["form-block"]} ${
        (main || popup) && styles["form-main"]
      } ${popup && styles["form-popup"]}`}
    >
      {!popup && (
        <>
          <p
      ...
      <form
        className={`${styles["form"]} ${styles["relative"]}`}
        onSubmit={handleSubmit}
      >
        <label
          className={`${styles["form__input"]} ${
            form.error.name && "input-form-error"
          }`}
        >
          ...
          <input
            ...
            onChange={(e) =>
              dispatch({ type: formActions.NAME, payload: e.target.value })
            }
        ...
        <label
          className={`${styles["form__input"]} ${
            form.error.number && "input-form-error"
          }`}
        >
          <div className={styles["form__icon"]}>
          ...
          <input
            ...
            onChange={(e) =>
              dispatch({ type: formActions.NUMBER, payload: e.target.value })
            }
        ...
        <label
          className={`${styles["form__input"]} ${
            form.error.activity_type && "input-form-error"
          }`}
        >
          <div className={styles["form__icon"]}>
          ...
          <input
            placeholder={t("form:placeholder_activity")}
            onChange={(e) =>
              dispatch({
                type: formActions.ACTIVITY_TYPE,
        ...
        {(main || type === "offer") && (
          <label
            className={`${styles["form__input"]} ${
              form.error.company_name && "input-form-error"
            }`}
          >
            <div className={styles["form__icon"]}>
            ...
            <input
              placeholder={t("form:placeholder_company_name")}
              onChange={(e) =>
                dispatch({
                  type: formActions.COMPANY_NAME,
                  payload: e.target.value,
                })
              }
        ...
        <textarea
          className={`${styles["form__textarea"]} ${
            form.error.comment && "input-form-error"
          }`}
          placeholder={t("form:placeholder_comment")}
          onChange={(e) =>
            dispatch({ type: formActions.COMMENT, payload: e.target.value })
          }
